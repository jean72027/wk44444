...
const knowledgepage = ({ navigation }) => {
 //   render () {
        return (
          ...
          <View>
            <Text style={styles.cardtitle1}>九柱神</Text>
            ...
            <Image style={styles.cardpic} source={require('./icon/Ra.png')}/>
    ...
    <View style={styles.card}>
            ...
            <Image style={styles.cardpic} resizeMode='stretch' source={require('./icon/Shu.png')}/>
            <View style={styles.cardtext}>
    ...
    <View style={styles.card}>
            ...
            <Image style={styles.cardpic} source={require('./icon/Tefnut.png')}/>
            <View style={styles.cardtext}>
    ...
    <View style={styles.card}>
            ...
            <Image style={styles.cardpic} source={require('./icon/Geb.png')}/>
            <View style={styles.cardtext}>
                ...
                <Text style={styles.article}>生下了四個孩子</Text>
            </View>
    
    </View>
    <View style={styles.card}>
            
            <Image style={styles.cardpic} source={require('./icon/Nut.png')}/>
            <View style={styles.cardtext}>
    ...
    <View style={styles.card}>
            ...
            <Image style={styles.cardpic} source={require('./icon/Osiris.png')}/>
            <View style={styles.cardtext}>
                ...
                <Text style={styles.article}>與伊西斯生下荷魯斯</Text>
            </View>
    
    </View>
    <View style={styles.card}>
            
            <Image style={styles.cardpic} source={require('./icon/Isis.png')}/>
            <View style={styles.cardtext}>
    ...
    <View style={styles.card}>
            ...
            <Image style={styles.cardpic} source={require('./icon/Set.png')}/>
            <View style={styles.cardtext}>
    ...
    <View style={styles.card}>
            ...
            <Image style={styles.cardpic} source={require('./icon/Nephthys.png')}/>
            <View style={styles.cardtext}>
                <Text style={styles.texttitle}>和諧之神 奈芙蒂斯</Text>
                <Text style={styles.article}>和諧與生育之神</Text>
                <Text style={styles.article}>賽特的妻子</Text>
          ...
          <View>
          <Text style={styles.cardtitle}>卡諾皮克罐</Text>
            <View style={styles.swipcontainer}>
                ...
                <View style={styles.card}>
                        ...
                        <View style={styles.cardtext}>
                            ...
                            <Text style={styles.article}>你，奧西里斯的孩子。我</Text>
                            <Text style={styles.article}>已經來了，我會保護你。」</Text>
                        </View>
          ...
          <View>
          <Text style={styles.cardtitle}>木乃伊製作</Text>
            <View style={styles.swipcontainer}>
                <Swiper style={styles.wrapper} height={270} horizontal={true} loop={ false }autoplay={ false }>
                <View style={styles.card}>
    ...
    <View style={styles.card}>
            ...
            <View style={styles.cardtext}>
                ...
                <Text style={styles.article}>取出遺體的肝、胃、肺、腸</Text>
                <Text style={styles.article}>並用食鹽吸乾水份</Text>
